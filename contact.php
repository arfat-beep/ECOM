            ...
            <div class="col-md-9">
                <div class="box">
                    <div class="box-header">
                        <center>
                            <h2>Contact Us</h2>
                            <p class="text-muted">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quibusdam aspernatur omnis dicta fugit eligendi aperiam maxime cumque ipsum consectetur. Amet, quo assumenda!</p>
                        </center>
                    </div>
                    ...
                    <?php
                    // This is for dynamic contact form
                        if(isset($_POST['submit'])){
                            ...
                            $receiver_email = "arfatrahman08@gmail.com";
                            
                            // Admin receive this message
                            
                        	mail("arfatrahman08@gmail.com","Email Form", $sender_message , "From: $sender_name $sender_subject <$sender_email>");
